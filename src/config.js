...
// Показывать лендинг (описание системы) на корневом адресе вместо
// прямого перехода на вход. По умолчанию выключено: у каждого клуба
// программа стоит на своём компьютере, и вход сотрудников должен
// открываться сразу, а не рекламная страница. Включается только на
// «витрине» — сайте, который продаёт систему клубам (например wespro.uz).
export const LANDING_AT_ROOT = process.env.WESPRO_LANDING_ROOT === "1";
